...
document.addEventListener('visibilitychange', function () {
    if (document.visibilityState === "visible") {
        document.title = "Portfolio | HARSH PANDEY";
...
/* SCROLL CERTIFICATES */
srtop.reveal('.certificates .cert-box', { interval: 150 });
